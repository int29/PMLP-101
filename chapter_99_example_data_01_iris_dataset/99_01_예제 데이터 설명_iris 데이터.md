...
```
<div align="center">
	<img src="https://github.com/int29/PMLP-101/blob/main/chapter_99_example_data_01_iris_dataset/99_08.png?raw=true" width=600>
	<p>[그림9908]</p>
</div>
...
```
<div align="center">
	<img src="https://github.com/int29/PMLP-101/blob/main/chapter_99_example_data_01_iris_dataset/99_09.png?raw=true" width=600>
	<p>[그림9909]</p>
</div>
...
데이터체크는 (1) 데이터를 육안으로 확인하기(데이터 HEAD&TAIL), (2) 데이터 사이즈 (3) 데이터 스키마, (4) 데이터 결측값 확인까지 총 4가지 과정을 진행한다.



### 탐색적 데이터 분석 EDA (Exporalatory Data Analysis)
